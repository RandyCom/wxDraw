...
export class Shape {
  constructor(type, option, strokeOrfill, draggable) {
    this.draggable = !!draggable;
    this.strokeOrfill = strokeOrfill || "fill"; //是否填充
    this.type = type;
  ...
  clone() {
    ...
    let _clone = new Shape(
      this.type,
      { ...this.Shape.Option, ...this.Shape.UnOption, ..._spaAttr },
      this.strokeOrfill,
      this.draggable,
    );
    return _clone;
