...
export class Img extends CommonMethods {
  constructor(option) {
    super();
    ...
    let _temOption = util.extend(option, iOption);
    let _temUnOption = util.extend(option, iUnOption);
    ...
    this._offsetY = 0;
    // this.bus = null;
    this.rotateOrigin = this.Option.rotateOrigin;
    this.oriPoints = [];
    this._Points = [];
