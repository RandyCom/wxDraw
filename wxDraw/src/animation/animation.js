...
export class Animation {
  ...
  wraperAniComplete(afID, shaId, obj) {
    ...
    if (
      this.wraperAniCompleteOb[shaId].length == this.wraperAniCompleteOb.length
    ) {
